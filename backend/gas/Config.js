...
COLUMNS[SHEET.TRANSAKSI_BARBER] = ['TransaksiID', 'NomorTransaksi', 'Tanggal', 'Jam', 'PelangganID', 'NamaPelanggan', 'NoHP', 'CapsterID', 'NamaCapster', 'ItemsJSON', 'Subtotal', 'Diskon', 'DiskonType', 'GrandTotal', 'MetodeBayar', 'CashAmount', 'QrisAmount', 'Kembalian', 'Catatan', 'Status', 'KasirID', 'NamaKasir', 'ShiftID', 'CreatedAt', 'UpdatedAt', 'Deleted', 'DeletedAt', 'DeletedBy'];
COLUMNS[SHEET.TRANSAKSI_WARKOP] = ['TransaksiID', 'NomorTransaksi', 'Tanggal', 'Jam', 'NamaPelanggan', 'ItemsJSON', 'Subtotal', 'Diskon', 'DiskonType', 'GrandTotal', 'MetodeBayar', 'CashAmount', 'QrisAmount', 'Kembalian', 'SplitBillJSON', 'Catatan', 'Status', 'KasirID', 'NamaKasir', 'ShiftID', 'CreatedAt', 'UpdatedAt', 'Deleted', 'DeletedAt', 'DeletedBy'];
