...
export function renderLayout(root) {
  ...
  root.innerHTML = `
    <div class="min-h-screen lg:flex">
      ...
      <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 -translate-x-full transform overflow-y-auto overscroll-contain border-r border-slate-200/70 bg-white/90 p-4 backdrop-blur-xl transition-transform duration-200 lg:sticky lg:top-0 lg:h-screen lg:self-start lg:translate-x-0 lg:border-slate-200 dark:border-white/10 dark:bg-slate-900/90 lg:dark:bg-slate-950">
